    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="md">
      ...
      <div className="mt-6 flex justify-end space-x-3">
        <button
          ...
          onClick={onClose}
          disabled={isLoading}
          className="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-50"
        >
          {cancelText}
        </button>
        <button
