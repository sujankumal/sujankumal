...
const Navbar = () => {
  ...
  return (<>
    <Suspense fallback={<div className="h-12"></div>}>
      ...
      <nav className={"w-full bg-gray-800 border-t-4 border-orange-600 shadow" + fixedNavClass} ref={elementRef}>
          ...
          >
            <ul className="items-center space-y-8 pl-6 pt-6 md:flex md:pl-0 md:pt-0 md:space-x-6 md:space-y-0">
              {menu.map(({ name, url }, index) => (
                <li key={index} className="text-white text-sm uppercase hover:text-orange-600 duration-300">
