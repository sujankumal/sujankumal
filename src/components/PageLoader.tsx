...
export default function PageLoader() {
  ...
  useEffect(() => {
    ...
    if (!win.__pageLoaderHistoryPatched) {
      win.__pageLoaderHistoryPatched = true;
  ...
  return (
    <div style={{ position: 'fixed', left: 0, right: 0, bottom: 24, display: 'flex', justifyContent: 'center', zIndex: 40 }}>
